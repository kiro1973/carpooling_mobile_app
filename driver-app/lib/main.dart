// main.dart
import 'package:driverApp/addRoute_selection.dart';
import 'package:flutter/material.dart';
import 'login_screen.dart';
import 'register_screen.dart';
import '/addRoute.dart';
import '/myRides.dart';
import '/myRidesWithTime.dart';
import 'ride_stat.dart';
import 'History.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      routes: {
        ...
        '/addRoute': (context) => SubmitRideScreen(),
        '/addRoute_selection': (context) => addRouteScreen(),
        '/myRides': (context) => MyRides(),
        '/myRidesWithTime': (context) => MyRidesWithTime(),
